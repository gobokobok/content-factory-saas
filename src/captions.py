...
_ASS_HEADER = (
    ...
    "Style: Default,Open Sans,56,&H0000FFFF,&H000000FF,&H00000000,&H80000000,"
...
_CAPTIONS_ASS_HEADER = (
    ...
    " Bold, Italic, Underline, StrikeOut, ScaleX, ScaleY, Spacing, Angle, BorderStyle, Outline,"
    " Shadow, Alignment, MarginL, MarginR, MarginV, Encoding\n"
    "Style: VoiceCaption,Montserrat ExtraBold,72,&H00FFFFFF,&H000000FF,&H00000000,&H80000000,"
    "0,0,0,0,100,100,0,0,1,6,0,2,10,10,250,1\n"
    "\n"
    "[Events]\n"
    "Format: Layer, Start, End, Style, Name, MarginL, MarginR, MarginV, Effect, Text\n"
)
