...
| E1-S2b | Migrate storage from Google Drive to Cloudflare R2 | ready |
| E1-S3 | Storyboard generation (Claude API call with v0.4 prompt, parse, upload to R2, update run_log.json) | backlog |
